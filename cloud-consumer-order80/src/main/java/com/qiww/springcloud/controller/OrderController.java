...
public class OrderController {
    ...
    public String paymentZipkin(Payment payment) {
        log.info("consumer ----->  payemntZipkin");
        String result = restTemplate.postForObject(PAYMENT_URL + "/payment/zipkin", payment, String.class);
        return result;
    }
